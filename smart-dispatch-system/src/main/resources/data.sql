...
INSERT INTO vehicle_location (vehicle_id, longitude, latitude, time_stamp) VALUES
  (1, 31.52989414, 30.15191184, CURRENT_TIMESTAMP),
  (2, 31.45398367, 29.98759687, CURRENT_TIMESTAMP),
  (3, 31.44278474, 30.14202123, CURRENT_TIMESTAMP),
  (4, 31.30921143, 29.79536515, CURRENT_TIMESTAMP),
  (5, 31.24731505, 29.9490176, CURRENT_TIMESTAMP),
  (6, 31.43146978, 29.90093267, CURRENT_TIMESTAMP),
  (7, 31.37428859, 29.83255976, CURRENT_TIMESTAMP),
  (8, 31.5089829, 30.17182477, CURRENT_TIMESTAMP),
  (9, 31.4180323, 30.11354011, CURRENT_TIMESTAMP),
  (10, 31.37327878, 30.07770972, CURRENT_TIMESTAMP);
SET @citizen_id = NULL;
